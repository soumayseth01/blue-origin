...
function njRenderRelease(notebook) {
  ...
  const ready = outputs.every(([, , ,p])=>p) && projects.presentation?.status === "approved" && projects.video?.status === "ready";
