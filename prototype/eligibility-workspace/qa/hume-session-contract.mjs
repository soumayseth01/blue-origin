...
assert.match(initial.system_prompt, /critical interview turn rule/i);
assert.match(initial.system_prompt, /learner owns the agenda/i);
assert.match(initial.system_prompt, /never end a factual answer with a question/i);
